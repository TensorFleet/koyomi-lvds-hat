# Koyomi RGB compact r2.7 print model

This bundle is generated from the single-side-assembly R2.7 compact LCD
controller floorplan in
`variants/koyomi-lvds-hat-rgb-compact-r2.7-30pct-floorplan/`.

Use `koyomi-rgb-compact-r2.7-print-mockup.stl` at **100% scale in
...
`/Applications/FreeCAD.app/Contents/MacOS/FreeCAD -c variants/koyomi-lvds-hat-rgb-compact-r2.7-30pct-floorplan/scripts/generate_print_model.py`
