#!/usr/bin/env python3
"""Generate the compact Koyomi r2.8 populated 3D-print fit gauge.
...
WORK = OUT / ".work"
RAW_STEP = WORK / "koyomi-rgb-compact-r2.8-populated.step"
NAME = "koyomi-rgb-compact-r2.8-print-mockup"
...
report = {
    "units": "mm",
    "revision": "Koyomi RGB compact r2.8 C91592 production candidate",
