# Koyomi RGB/DPI LVDS — compact r2.0
...
The r2.0 floorplan reaches exactly **65.0 × 28.25 mm**, or 1,836.25 mm²: half
the donor area. Fresh all-severity DRC has no courtyard, edge-clearance,
shorting, or other physical-placement violations. It reports 19 inherited
library warnings and 137 expected opens because donor routing was deliberately
