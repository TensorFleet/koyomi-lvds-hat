#!/usr/bin/env python3
"""Generate the compact Koyomi r2.9 populated 3D-print fit gauge.
...
WORK = OUT / ".work"
RAW_STEP = WORK / "koyomi-rgb-compact-r2.9-populated.step"
NAME = "koyomi-rgb-compact-r2.9-print-mockup"
...
doc = App.newDocument("koyomi_r29_source")
...
report = {
    "units": "mm",
    "revision": "Koyomi RGB compact r2.9 silkscreen-clearance production candidate",
