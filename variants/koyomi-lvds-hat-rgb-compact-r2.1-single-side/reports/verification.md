# Koyomi RGB compact r2.1 single-side floorplan verification
...
- Assembly sides: 20 SMD footprints on front, 0 SMD footprints on back.
- Total placed footprints: 28 front, 0 back (including mounting and
...
- DRC opens: 127, expected because donor routing and zones were deliberately
  removed before compact placement.
- ERC all-severity: 83 findings, including the same three inherited
