...
This is a fabrication-ready prototype, not final system approval. The mating B2.2 carrier and straight-through 40-contact cable are required. The external backlight circuit must implement the documented LCD_INS# pull-up and hardware interlock. Verify live JLC inventory, especially private-library connector C5311655, before checkout.
